...
class StateNormalization(object):
    def __init__(self):
        ...
        # self.high_state = np.array(
        #     [500000, 100, 100, 60 * 1048576,          - uav battery main, uav loc, remain sum task size 
        #      100, 100, 100, 100, 100, 100, 100, 100,  - all ue location
        #      2097152, 2097152, 2097152, 2097152,      - all ue task size
        #      1, 1, 1, 1])                             - all ue block_flag
